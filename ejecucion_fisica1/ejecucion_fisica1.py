...
class ejecucion_fisica(osv.osv):
    ...
    def valida_fecha_eje_plan(self, cr, uid, ids, context=None):
        ...
        for r in self.browse(cr,uid,ids):
            v1=cmp(r.fecha_planificacion,r.fecha_ejecucion)
            v2=cmp(r.fecha_planificacion,hoy)
            v3=cmp(r.fecha_ejecucion,hoy)
            if v1==1:
        ...
        return True
    _constraints = [
  (valida_fecha_eje_plan,mensaje,  ['validacion de fechas']),
   ]
